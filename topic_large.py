...
#model_name = "smollm2:1.7b" # Accuracy: 0.2990
#model_name ="gemma3:1b" # Accuracy: 0.7835
#model_name ="gemma3:4b" # Accuracy: 0.8041
#model_name = "llama3.2:1b" # Accuracy: 0.0825
#model_name="phi4-mini:latest" # Accuracy: 0.8247
model_name="granite3.3:2b" # Accuracy: 0.8351
# Path to your labeled data file (CSV)
data_file_path = "data/labeled_topic_large_data.csv"
...
topics = ["technology", "health", "sports", "politics", "entertainment", "history", "business", "travel", "food", "education", "environment", "science"]
